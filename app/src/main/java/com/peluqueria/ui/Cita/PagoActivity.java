...
public class PagoActivity extends AppCompatActivity {
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!payerName.equals("") && !upiId.equals("") && !msgNote.equals("") && !sendAmount.equals("")){
                    ...
                    Toast.makeText(PagoActivity.this,"Campos obligatorios,intente de nuevo.", Toast.LENGTH_SHORT).show();
    ...
    private void payWithGpay(String packageName){
        ...
        if(isAppInstalled(this,packageName)){
            ...
            Toast.makeText(PagoActivity.this,"Google pay no esta instalado. Porfavor instale e intente de nuevo.", Toast.LENGTH_SHORT).show();
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if ((RESULT_OK == resultCode) && status.equals("success")) {
            Toast.makeText(PagoActivity.this, "Transaction successful. "+approvalRefNo, Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(PagoActivity.this, "Transaccion cancelada o fallida, porfavor intente de nuevo.", Toast.LENGTH_SHORT).show();
